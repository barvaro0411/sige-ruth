...
import { Estudiante, Sede } from '../../types';

interface MatriculaPreviewModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function MatriculaPreviewModal({ isOpen, onClose, estudiante, sede }: MatriculaPreviewModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Ficha de Matrícula: ${estudiante.nombre} ${estudiante.apellidoPaterno}`}>
      <div className="matricula-preview-container" style={{ display: 'flex', flexDirection: 'column', height: '80vh' }}>
        ...
        <div className="matricula-preview-toolbar" style={{ 
          display: 'flex', 
          ...
          <div className="matricula-preview-title" style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
            <div style={{ 
          ...
          <div className="matricula-preview-actions" style={{ display: 'flex', gap: 'var(--space-3)' }}>
            <PDFDownloadLink 
        ...
        {/* Visor de PDF */}
        <div className="matricula-preview-viewer" style={{ flex: 1, backgroundColor: 'var(--color-gray-100)', overflow: 'hidden' }}>
        ...
        {/* Footer informativo */}
        <div className="matricula-preview-footer" style={{ 
