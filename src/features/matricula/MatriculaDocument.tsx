...
export function MatriculaDocument({ estudiante, sede }: MatriculaDocumentProps) {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.subtitleRoot}>Sede {sede.nombre} - RBD: {sede.rbd || '10375-6'}</Text>
          </View>
        ...
        <View style={styles.sectionInfo}>
          ...
          <View style={styles.grid}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>{estudiante.fechaNacimiento ? new Date(estudiante.fechaNacimiento).toLocaleDateString('es-CL') : 'No Registrada'}</Text>
            </View>
          </View>
        </View>
