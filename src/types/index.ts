...
export interface Estudiante extends Omit<Tables['estudiantes'], 'apellido_paterno' | 'apellido_materno' | 'fecha_nacimiento' | 'prueba_inicial' | 'nombre_apoderado' | 'telefono_apoderado' | 'sede_id' | 'curso_id' | 'created_at'> {
...
export interface Asistencia extends Omit<Tables['asistencia'], 'estudiante_id' | 'registrado_por' | 'sede_id' | 'created_at'> {
  estudianteId: number;
